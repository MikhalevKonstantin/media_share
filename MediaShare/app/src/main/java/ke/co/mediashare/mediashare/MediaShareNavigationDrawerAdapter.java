 ...
 */
public class MediaShareNavigationDrawerAdapter extends RecyclerView.Adapter<MediaShareNavigationDrawerAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, int ViewType) {
            ...
            if (ViewType == TYPE_ITEM) {
                ...
                viewHolder_Name = (TextView) itemView.findViewById(R.id.text_profile_name);
                viewHolder_Email = (TextView) itemView.findViewById(R.id.text_profile_email);
    ...
    MediaShareNavigationDrawerAdapter(String Navigation_Titles[], int Navigation_Icons[], String Name, String Email, int Profile_Photo) {
    ...
    @Override
    public void onBindViewHolder(MediaShareNavigationDrawerAdapter.ViewHolder holder, int position) {
